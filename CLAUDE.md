...
**YOU ARE IN: `controlle/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/controlle/` (rig root) or other directories
...
**Your mail address:** `controlle/polecats/obsidian`
**Your rig:** controlle
**Your Witness:** `controlle/witness`
...
| Ask Witness for help | `gt mail send controlle/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`controlle/witness`) when:
...
```bash
gt mail send controlle/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
