...
> [!WARNING]
> This project was entirely vibe-coded by AI agents. No human has reviewed the
> actual code — only the end-to-end functionality has been verified by a human
> operator. It likely contains bugs, edge cases, and questionable decisions.
